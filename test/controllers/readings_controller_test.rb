...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { name: @reading.name, reading_url: @reading.reading_url } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { name: @reading.name, reading_url: @reading.reading_url } }
